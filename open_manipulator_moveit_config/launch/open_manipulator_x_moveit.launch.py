...
def generate_launch_description():
    ...
    moveit_config = (
        ...
        .robot_description(mappings={"use_sim": use_sim})
    ...
    servo_yaml_path = (
        Path(get_package_share_directory("open_manipulator_moveit_config"))
        / "config"
        / "open_manipulator_x"
        / "servo.yaml"
    )
    with open(servo_yaml_path, "r", encoding="utf-8") as servo_yaml:
        servo_params = {"moveit_servo": yaml.safe_load(servo_yaml)}
