...
"""Launch the OpenMANIPULATOR-X zero-g practice world and direct MoveIt demo."""
...
def generate_launch_description() -> LaunchDescription:
    ...
    zero_g_world = PathJoinSubstitution([
    ...
    demo = Node(
        ...
        executable="demo_zero_g_practice",
        output="screen",
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            "setup_only",
            default_value="false",
            description="Mirror planning scene and validate services without motion",
        ),
        DeclareLaunchArgument(
            "wait_timeout_sec",
            default_value="30.0",
            description="Seconds to wait for MoveIt action servers",
        ),
        DeclareLaunchArgument(
            "log_level",
            default_value="info",
